...
import trackomunda.components.gangRoster
...
class MainFrame(props: MainFrameProps) : RComponent<MainFrameProps, MainFrameState>(props) {
    ...
    private val nameToTestMap = hashMapOf(
        "GangRoster" to RBuilder::gangRoster,
                ...
                styledDiv {
                    ...
                    mAppBar(position = MAppBarPosition.absolute) {
                        ...
                        mToolbar {
                            ...
                            mToolbarTitle("Trackomunda - ${state.view}")
...
//            mListItem(caption, onClick = {setState {currentView = caption}})
        ...
        themeContext.Consumer { theme ->
            mList {
                ...
                nameToTestMap.keys.sortedWith { a, b -> if (a == "GangRoster") -1 else if (b == "GangRoster") 1 else a.compareTo(b) }
