...
sealed class FighterAction(val name: String, val requiredStatus: Set<FighterStatus> = setOf(STANDING), val additionalCondition: (GameFighter) -> Boolean = { !it.isOutOfAction && !it.isBlazed })
